  ...
  return (
    <div className="product-day">
      <div className="product-day-img">
        <img src={Cat} alt="agrigram-prod-day" />
      </div>
      ...
      <div className="product-day-info">
        ...
        <p className="product-day-info__desc">
          Et id lectus vitae tellus quisque. Eu elementum id quis magnis
          molestie urna condimentum pellentesque. Eget et purus eu eu posuere
          amet mauris turpis.
        </p>
